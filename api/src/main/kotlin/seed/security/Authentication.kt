...
fun loginRequired(keycloakURL: URL, keycloakHost: String?, client: HttpHandler = ApacheClient()): Filter {
    val keycloakClient = KeycloakClient(keycloakURL, keycloakHost, client)
    return Filter { next ->
        { req ->
            try {
...
fun loginHandler(keycloakURL: URL, keycloakHost: String?, client: HttpHandler = ApacheClient()): HttpHandler {
    val keycloakClient = KeycloakClient(keycloakURL, keycloakHost, client)
...
fun refreshHandler(keycloakURL: URL, keycloakHost: String?, client: HttpHandler = ApacheClient()): HttpHandler {
    val keycloakClient = KeycloakClient(keycloakURL, keycloakHost, client)
...
fun logoutHandler(keycloakURL: URL, keycloakHost: String?, client: HttpHandler = ApacheClient()): HttpHandler {
    val keycloakClient = KeycloakClient(keycloakURL, keycloakHost, client)
